...
Code is attributable to Cameron Pittman and Udacity course.
*/
/*
These are HTML strings with the %data% or # replaced through the resumeBuilder.js file.
*/
...
var HTMLonlineTitle = '<a class="online-school" href="#">%data%';
var HTMLonlineSchool = ' - %data%</a><br>';
var HTMLonlineDates = '<div class="date-text online-dates">%data%</div><br>';
...
function initializeMap() {
    ...
    */
    function createMapMarker(placeData) {
        ...
        // Opens an infowindow with location name when user clicks on marker.
...
// and adjust map bounds for both maps
window.addEventListener('resize', function(e) {
    //Make sure the map bounds get updated on page resize for both maps
